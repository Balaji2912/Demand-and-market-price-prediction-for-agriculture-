...
st.markdown("<h1 style='text-align: center, color: purple'>Demand and Market Price Prediction - Farmer's Guide</h1>", unsafe_allow_html=True)
...
options.binary_location = "./chrome"  # Path to Chrome binary
...
if(st.button('Predict')):
    ...
    typeofrep=driver.find_element(By.ID,"ctl00_MainContent_Rbl_Rpt_type_0")
    typeofrep.click()
